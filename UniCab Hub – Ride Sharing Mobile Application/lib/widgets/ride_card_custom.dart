...
class RideCardCustom extends StatefulWidget {
  RideCardCustom({Key? key, required this.ride, required this.user});
  Ride ride;
  UserC user;
                      ...
                      children: [
                          ...
                          child: Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Text(
                                  widget.ride.acceptType == "-" ? "All bikes" : widget.ride.acceptType,
                                  style: const TextStyle(
                                    fontWeight: FontWeight.w500,
                                    fontSize: 16,
                                    color: Color(0xFF444444),
                        ...
                        Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              Text(
                                "• ${widget.ride.highway ? "highway" : "no highway"}",
                                style: const TextStyle(
