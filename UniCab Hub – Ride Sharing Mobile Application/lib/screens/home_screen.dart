...
class HomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    itemsList = [
      {"imgName": "motorbike", "text": "New ride", "page": const AddRideScreen()},
      {"imgName": "rider", "text": "My rides", "page": const MyRidesScreen()},
      {"imgName": "world", "text": "Friends' activities", "page": const FriendsActivityScreen()},
    ];
