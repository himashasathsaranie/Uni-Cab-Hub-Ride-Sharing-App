...
class _FindRideScreenState extends State<FindRideScreen> {
  ...
  void _handleDataReceived(bool filter) {
    setState(() {
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: Column(
          ...
          children: [
            OfferOverviewCustom(isFilterShown: isFilterShown, onDataReceived: _handleDataReceived, onClearFilters: _handleFilterData),
            Visibility(
              ...
              builder: (context, snapshot) {
                ...
                if (rides.isEmpty) {
                  return SingleChildScrollView(
                    child: Column(
                      children: [
                        const ErrorMessageCustom(text: "No rides found."),
                        GestureDetector(
...
class OfferOverviewCustom extends StatefulWidget {
  OfferOverviewCustom({Key? key, required this.isFilterShown, required this.onDataReceived, required this.onClearFilters});
  bool isFilterShown;
        ...
        children: [
          ...
          Padding(
            ...
            child: GestureDetector(
              onTap: () => {
                setState(() {
                  widget.onDataReceived(!widget.isFilterShown);
                })
              },
              child: Container(
                decoration: BoxDecoration(
